...
public class CalendarService {
    ...
    public CalendarMemoDTO getMemoDayDetail(UUID userId, String yyyymmdd) {
        CalendarMemoDTO detailDTO = calendarQueryRepository.findMemoDayDetail(userId, yyyymmdd);
        return detailDTO;
    }
